  ...
  return (
    <>
      <tr className="text-sm">
                  ...
                  <div>
                    {ratings.find(
                      ...
                      <button
                        ...
                        className={`text-indigo-600 hover:bg-indigo-50 px-3 py-1 rounded transition ${
        ...
        <td className="text-center max-md:hidden font-medium text-slate-800">
          {currency}
          {order.total}
        </td>

        <td className="text-left max-md:hidden text-slate-600">
          <p>
        ...
        <td colSpan={5} className="py-4 px-2">
          <div className="bg-slate-50 p-3 rounded-lg border border-slate-100">
            ...
            <div className="flex items-center mt-3">
              <span className="text-center mx-auto px-6 py-1.5 rounded bg-indigo-100 text-indigo-700 font-medium">
      ...
      <tr>
        <td colSpan={4}>
          <div className="border-b border-slate-200 w-full my-4" />
        </td>
      </tr>
    </>
  );
